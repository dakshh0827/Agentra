      ...
      <div className="flex items-center gap-3 p-4 border-b border-[var(--color-border)]">
        ...
        <AnimatePresence>
          {!collapsed && (
            ...
            >
              <div className="font-display font-bold text-sm text-[var(--color-text-primary)] tracking-[0.15em]">NEURAL</div>
              <div className="font-mono text-[9px] text-[var(--color-purple-bright)] tracking-[0.4em]">MARKET</div>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
