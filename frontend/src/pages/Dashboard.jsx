      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-[var(--color-text-muted)] text-sm mb-6 leading-relaxed">
            Connect your wallet to view your personal analytics, revenue, and agent performance.
          </p>
      ...
      <div className="relative z-10 p-5 lg:p-8 max-w-7xl mx-auto">
          ...
          {metricCards.map((m, i) => (
            ...
            >
              <div className={`glass-card-landing rounded-xl p-4 sm:p-5 relative overflow-hidden transition-all duration-300 ${
                hoveredMetric === m.label ? 'scale-[1.02]' : ''
              }`}>
              ...
              {revenueData.length > 0 ? (
                <ResponsiveContainer width="100%" height={200}>
                  <AreaChart data={revenueData}>
                    ...
                    <Area type="monotone" dataKey="eth" stroke="#a855f7" strokeWidth={2} fill="url(#revGrad)" name="ETH" />
                  </AreaChart>
                </ResponsiveContainer>
              ) : (
              ...
              <div className="space-y-3 overflow-y-auto max-h-52 pr-1 custom-scrollbar">
                {activityFeed.length > 0 ? activityFeed.map((item, i) => (
                  <motion.div
                    ...
                    whileHover={{ x: 4 }}
                    className="flex items-start gap-3 pb-3 border-b border-[var(--color-border)] last:border-0 cursor-default group"
                  >
        ...
        <FadeInSection delay={0.15}>
          <div className="glass-card-landing rounded-xl p-5 sm:p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="font-display font-bold text-[var(--color-text-primary)] text-base sm:text-lg">Agent Performance</h3>
